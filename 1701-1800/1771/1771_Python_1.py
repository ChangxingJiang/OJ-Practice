...
if __name__ == "__main__":
    print(Solution().longestPalindrome(word1="cacb", word2="cbba"))  # 5
    print(Solution().longestPalindrome(word1="ab", word2="ab"))  # 3
    print(Solution().longestPalindrome(word1="aa", word2="bb"))  # 0

    print(Solution().longestPalindrome(word1="ceebeddc", word2="d"))  # 3

    # 测试用例33/99
    print(Solution().longestPalindrome(word1="afaaadacb", word2="ca"))  # 6
